...
| formal equivalence | the stitcher is out of the trusted base: the full RTL-to-stitched chain proven in one equivalence at pilot scale, the transformation proven at 2138 triples by induction (2639/2639 points, 131 s), cell functions generated from the PDK liberty, vacuous passes refused by gate | scripts/formal_equiv.sh, make equiv |
