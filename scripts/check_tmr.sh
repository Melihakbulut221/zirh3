...
run_check "zirh_i2c      (I2C master, all-TMR)" \
    zirh_i2c 21 214 zirh_tmr_ff \
    zirh_tmr_lib.v zirh_i2c.v

run_check "zirh_spi      (SPI master, all-TMR)" \
...
run_check "zirh3_top     (full compute die + DFT)" \
    zirh3_top 79 43280 zirh_tmr_ff \
    ...
    zirh_gpio.v zirh_timer.v zirh_i2c.v zirh_spi.v zirh_uart1.v zirh_bank64.v zirh3_top.v
EXTRA_CMDS=""
