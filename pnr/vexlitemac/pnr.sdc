...
set_min_delay 1.2 -to [get_pins -hierarchical icache_data_m/A_*]
set_min_delay 1.2 -to [get_pins -hierarchical icache_data_m/B_ADDR*]
set_min_delay 1.2 -to [get_pins -hierarchical icache_data_m/B_REN]
set_min_delay 1.2 -to [get_pins -hierarchical icache_tags_m/A_*]
set_min_delay 1.2 -to [get_pins -hierarchical icache_tags_m/B_ADDR*]
set_min_delay 1.2 -to [get_pins -hierarchical icache_tags_m/B_REN]
