...
// Source: litex-hub/pythondata-cpu-vexriscv
//         @ 642ecfed1c84460555d6d803d660cc60cfc1ecb6
// File:   pythondata_cpu_vexriscv/verilog/VexRiscv_Min.v
// Role:   the 50 MHz P&R campaign's TIMING PILOT - cacheless RV32I with
//         the same pipeline structure as the shipping Lite core, so its
//         post-route critical path speaks for the pipeline while the
//         cache arrays (macro-bounded at hardening) stay out of the
